...
function defaultData() {
  return {
    ...
    lieuContrat: 'Limoges',
    marie1: { nom: '', prenom: '', mobile: '' },
    marie2: { nom: '', prenom: '', mobile: '' },
    adresse: '', cp: '', ville: '',
    email: '',
    source: '',
    sourceAutre: '',
...
function computeTotals(d) {
  ...
  const total = base + mairie + sup + km;
  const acompte = total * 0.30;
  return { base, mairie, sup, km, total, acompte, solde: total - acompte };
}
        ...
        <aside className="ep-panel no-print" data-omelette-chrome="">
          ...
          <div className="ep-body">
            ...
            {openSections.maries && (
              <div className="ep-grp">
                <div className="ep-row-2">
                  <Field label="Nom (1)"><TextInput value={data.marie1.nom} onChange={v => set('marie1.nom', v)} /></Field>
                  <Field label="Prénom (1)"><TextInput value={data.marie1.prenom} onChange={v => set('marie1.prenom', v)} /></Field>
                </div>
                <div className="ep-row-2">
                  <Field label="Nom (2)"><TextInput value={data.marie2.nom} onChange={v => set('marie2.nom', v)} /></Field>
                  <Field label="Prénom (2)"><TextInput value={data.marie2.prenom} onChange={v => set('marie2.prenom', v)} /></Field>
                </div>
                <Field label="Adresse"><TextInput value={data.adresse} onChange={v => set('adresse', v)} placeholder="12 rue …" /></Field>
                <div className="ep-row-2">
                  <Field label="Code postal"><TextInput value={data.cp} onChange={v => set('cp', v)} /></Field>
                  <Field label="Localité"><TextInput value={data.ville} onChange={v => set('ville', v)} /></Field>
                </div>
                <div className="ep-row-2">
                  <Field label="Mobile (1)"><TextInput type="tel" value={data.marie1.mobile} onChange={v => set('marie1.mobile', v)} /></Field>
                  <Field label="Mobile (2)"><TextInput type="tel" value={data.marie2.mobile} onChange={v => set('marie2.mobile', v)} /></Field>
                </div>
                <Field label="E-mail"><TextInput type="email" value={data.email} onChange={v => set('email', v)} /></Field>
            ...
            {openSections.data && (
              <div className="ep-grp">
                ...
                <div class="ep-actions">
                  <button type="button" className="ep-btn primary" onClick={handleMail} disabled={!data.email}>✉ Envoyer par mail</button>
                  <button type="button" className="ep-btn" onClick={handlePrint}>🖨 Imprimer / PDF</button>
                </div>
                {!data.email && <p className="ep-note tiny" style={{ color: 'rgba(255,200,140,0.7)' }}>→ Renseignez l'e-mail des mariés pour activer l'envoi.</p>}
